    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            ComputerStorage.ComputersList = new List<Computer>()
            {
                ...
                new Desktop(){ CPU = "AMD", GPU = "nvidia", NumberOfCore = 16, NumberOfRAM = 16, PriceWithoutNds = 3500, TypeBody = "small", PowerBlock = 650, SetDate = new DateTime(2018,11,15), IsSell = true },
                ...
                new Desktop(){ CPU = "intel", GPU = "AMD", NumberOfCore = 8, NumberOfRAM = 16, PriceWithoutNds = 3000, TypeBody = "big", PowerBlock = 500, SetDate = new DateTime(2016,3,4), IsSell = true },
                new Desktop(){ CPU = "intel", GPU = "AMD", NumberOfCore = 8, NumberOfRAM = 16, PriceWithoutNds = 3000, TypeBody = "big", PowerBlock = 800, SetDate = new DateTime(2019,3,4)},
